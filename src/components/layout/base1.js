  ...
  return (
    <Stack direction="row" spacing={0} sx={{ height: "auto" }}>
      ...
      >
        ...
        <Stack
          direction={"row"}
          sx={{ paddingLeft: "6%", marginBottom: "13%", marginTop: "10%" }}
        >
          <Typography variant="h4">Nexster</Typography>
        ...
        <List>
          ...
          <ListItem key={5} disablePadding>
            <ListItemButton
              onClick={() => setIsCreatePostOpen((preState) => !preState)}
            >
              <ListItemIcon sx={{ minWidth: 35, width: iconWidth }}>
        ...
        <ListItem key={6} disablePadding sx={{ marginTop: "15%" }}>
          ...
          >
            <ListItemIcon sx={{ minWidth: 35, width: iconWidth, padding: 1 }}>
              <Avatar
                alt={name}
        ...
        >
          <MenuItem onClick={() => navigate(`/index/${indexNo}`)}>
            {" "}
            Go to profile{" "}
          </MenuItem>
        ...
        <Typography
          variant="caption"
          sx={{ position: "fixed", bottom: 10, marginLeft: "0.8%" }}
        >
          {" "}
          © 2024 Namal Sanjaya{" "}
        </Typography>
